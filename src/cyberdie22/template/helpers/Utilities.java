...
import cyberdie22.multiversion.Sound;
import cyberdie22.multiversion.Version;
...
public final class Utilities {
    ...
    public static String convertToInvisibleString(String s) {
        if (Version.getVersion().equals(Version.v1_16)) return s; // HOTFIX to prevent invisible text being garbled by 1.16 changes // fixed in 1.16.3, might be fixed in 1.16.2
        String hidden = "";
